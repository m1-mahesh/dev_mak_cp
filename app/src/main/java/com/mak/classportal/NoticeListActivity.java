...
public class NoticeListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView)findViewById(R.id.tvTitle)).setText("Notice List");
        getTestList();
        NoticeListAd adapter1 = new NoticeListAd(this, allClassData);
...
//                        .setAction("Action", null).show();
                startActivity(new Intent(NoticeListActivity.this, NewNoticeActivity.class));
