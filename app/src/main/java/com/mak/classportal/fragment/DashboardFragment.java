...
public class DashboardFragment extends Fragment {
    ...
    void parseMenuList() {
        ...
        menu.setResourceId(R.drawable.checklist);
        ...
        menu1.setMenuId(3);
        menu1.setResourceId(R.drawable.plan);
        menu1.setId("notice");
        ...
        menu2.setMenuId(7);
        menu2.setResourceId(R.drawable.plan);
        ...
        menu4.setMenuId(8);
        menu4.setResourceId(R.drawable.plan);
