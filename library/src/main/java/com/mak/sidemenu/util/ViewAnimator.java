...
import com.mak.sidemenu.R;
import com.mak.sidemenu.animation.FlipAnimation;
...
public class ViewAnimator<T extends Resourceble> {
    ...
    public ViewAnimator(AppCompatActivity activity,
                        List<T> items,
                        Object screenShotable,
                        final DrawerLayout drawerLayout,
                        ViewAnimatorListener animatorListener) {
        this.appCompatActivity = activity;

        this.list = items;
        this.screenShotable = (ScreenShotable) screenShotable;
